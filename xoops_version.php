 ...
 * Licence: GNU
 */
$modversion['name'] = _X_TORRENT_NAME;
$modversion['version'] = 1.32;
$modversion['releasedate'] = 'Fri: 4 April 2008';
$modversion['status'] = 'Stable';
$modversion['description'] = _X_TORRENT_DESC;
$modversion['author'] = 'Chronolabs Australia';
$modversion['credits'] = 'Modified version of WF-Downloads';
$modversion['teammembers'] = 'Wishcraft, LordPeter, Monty';
$modversion['help'] = 'xtorrent.html';
$modversion['license'] = 'GPL see LICENSE';
$modversion['official'] = 0;
$modversion['image'] = 'images/xtorrent_slogo.png';
$modversion['dirname'] = 'xtorrent';
/*
...
$modversion['warning'] = _X_TORRENT_WARNINGTEXT;
$modversion['author_credits'] = _X_TORRENT_AUTHOR_CREDITSTEXT;

// Sql file (must contain sql generated by phpMyAdmin or phpPgAdmin)
// All tables should not have any prefix!
$modversion['sqlfile']['mysql'] = 'sql/xtorrent.sql';
// $modversion['sqlfile']['postgresql'] = "sql/pgsql.sql";
// Tables created by sql file (without prefix!)
$modversion['tables'][0] = 'xtorrent_broken';
$modversion['tables'][1] = 'xtorrent_cat';
$modversion['tables'][2] = 'xtorrent_downloads';
$modversion['tables'][3] = 'xtorrent_mod';
$modversion['tables'][4] = 'xtorrent_votedata';
$modversion['tables'][5] = 'xtorrent_indexpage';
$modversion['tables'][6] = 'xtorrent_reviews';
$modversion['tables'][7] = 'xtorrent_mimetypes';
$modversion['tables'][8] = 'xtorrent_tracker';
$modversion['tables'][9] = 'xtorrent_torrent';
$modversion['tables'][10] = 'xtorrent_poll';
$modversion['tables'][11] = 'xtorrent_files';
$modversion['tables'][12] = 'xtorrent_peers';
$modversion['tables'][13] = 'xtorrent_users';
// Admin things
$modversion['hasAdmin'] = 1;
$modversion['adminindex'] = 'admin/index.php';
$modversion['adminmenu'] = 'admin/menu.php';
// Blocks
$modversion['blocks'][1]['file'] = 'xtorrent_top.php';
$modversion['blocks'][1]['name'] = _X_TORRENT_BNAME1;
$modversion['blocks'][1]['description'] = 'Shows recently added donwload files';
$modversion['blocks'][1]['show_func'] = 'b_XTORRENT_top_show';
$modversion['blocks'][1]['edit_func'] = 'b_XTORRENT_top_edit';
$modversion['blocks'][1]['options'] = 'date|10|19';
$modversion['blocks'][1]['template'] = 'xtorrent_block_new.html';

$modversion['blocks'][2]['file'] = 'xtorrent_top.php';
$modversion['blocks'][2]['name'] = _X_TORRENT_BNAME2;
$modversion['blocks'][2]['description'] = 'Shows most downloaded files';
$modversion['blocks'][2]['show_func'] = 'b_XTORRENT_top_show';
$modversion['blocks'][2]['edit_func'] = 'b_XTORRENT_top_edit';
$modversion['blocks'][2]['options'] = 'hits|10|19';
$modversion['blocks'][2]['template'] = 'xtorrent_block_top.html';
// Menu
...
$xoopsDLModule = $moduleHandler->getByDirname('xtorrent');
...
if ($submissions) {
    ...
    $modversion['sub'][$i]['name'] = _X_TORRENT_SMNAME1;

    $modversion['sub'][$i]['url'] = 'submit.php';
}
$i++;
$modversion['sub'][$i]['name'] = _X_TORRENT_SMNAME2;
$modversion['sub'][$i]['url'] = 'topten.php?list=hit';
$i++;
$modversion['sub'][$i]['name'] = _X_TORRENT_SMNAME3;
$modversion['sub'][$i]['url'] = 'topten.php?list=rate';
unset($i);
// Search
$modversion['hasSearch'] = 1;
$modversion['search']['file'] = 'include/search.inc.php';
$modversion['search']['func'] = 'xtorrent_search';
// Comments
...
// Templates
$modversion['templates'][1]['file'] = 'xtorrent_brokenfile.html';
$modversion['templates'][1]['description'] = '';
$modversion['templates'][2]['file'] = 'xtorrent_download.html';
$modversion['templates'][2]['description'] = '';
$modversion['templates'][3]['file'] = 'xtorrent_index.html';
$modversion['templates'][3]['description'] = '';
$modversion['templates'][4]['file'] = 'xtorrent_modfile.html';
$modversion['templates'][4]['description'] = '';
$modversion['templates'][5]['file'] = 'xtorrent_ratefile.html';
$modversion['templates'][5]['description'] = '';
$modversion['templates'][6]['file'] = 'xtorrent_singlefile.html';
$modversion['templates'][6]['description'] = '';
$modversion['templates'][7]['file'] = 'xtorrent_submit.html';
$modversion['templates'][7]['description'] = '';
$modversion['templates'][8]['file'] = 'xtorrent_topten.html';
$modversion['templates'][8]['description'] = '';
$modversion['templates'][9]['file'] = 'xtorrent_viewcat.html';
$modversion['templates'][9]['description'] = '';
$modversion['templates'][10]['file'] = 'xtorrent_newlistindex.html';
$modversion['templates'][10]['description'] = '';
$modversion['templates'][11]['file'] = 'xtorrent_viewlist.html';
$modversion['templates'][11]['description'] = '';
$modversion['templates'][12]['file'] = 'xtorrent_reviews.html';
$modversion['templates'][12]['description'] = '';

//Module config setting
$modversion['config'][1]['name'] = 'popular';
$modversion['config'][1]['title'] = '_X_TORRENT_POPULAR';
$modversion['config'][1]['description'] = '_X_TORRENT_POPULARDSC';
...
$modversion['config'][2]['title'] = '_X_TORRENT_ICONDISPLAY';
$modversion['config'][2]['description'] = '_X_TORRENT_DISPLAYICONDSC';
$modversion['config'][2]['formtype'] = 'select';
$modversion['config'][2]['valuetype'] = 'int';
$modversion['config'][2]['default'] = 1;
$modversion['config'][2]['options'] = ['_X_TORRENT_DISPLAYICON1' => 1, '_X_TORRENT_DISPLAYICON2' => 2, '_X_TORRENT_DISPLAYICON3' => 3];

$modversion['config'][41]['name'] = 'daysnew';
$modversion['config'][41]['title'] = '_X_TORRENT_DAYSNEW';
$modversion['config'][41]['description'] = '_X_TORRENT_DAYSNEWDSC';
...
$modversion['config'][42]['title'] = '_X_TORRENT_DAYSUPDATED';
$modversion['config'][42]['description'] = '_X_TORRENT_DAYSUPDATEDDSC';
...
$modversion['config'][3]['title'] = '_X_TORRENT_PERPAGE';
$modversion['config'][3]['description'] = '_X_TORRENT_PERPAGEDSC';
...
$modversion['config'][35]['title'] = '_X_TORRENT_ADMINPAGE';
$modversion['config'][35]['description'] = '_X_TORRENT_AMDMINPAGEDSC';
...
$modversion['config'][39]['title'] = '_X_TORRENT_ARTICLESSORT';
$modversion['config'][39]['description'] = '_X_TORRENT_ARTICLESSORTDSC';
...
$modversion['config'][39]['options'] = [
    _X_TORRENT_TITLE . $qa => 'title ASC',
    _X_TORRENT_TITLE . $qd => 'title DESC',
    _X_TORRENT_SUBMITTED2 . $qa => 'published ASC',
    _X_TORRENT_SUBMITTED2 . $qd => 'published DESC',
    _X_TORRENT_RATING . $qa => 'rating ASC',
    _X_TORRENT_RATING . $qd => 'rating DESC',
    _X_TORRENT_POPULARITY . $qa => 'hits ASC',
    _X_TORRENT_POPULARITY . $qd => 'hits DESC',
    _X_TORRENT_WEIGHT => 'weight',
];

$modversion['config'][32]['name'] = 'subcats';
$modversion['config'][32]['title'] = '_X_TORRENT_SUBCATS';
$modversion['config'][32]['description'] = '_X_TORRENT_SUBCATSDSC';
...
$modversion['config'][6]['title'] = '_X_TORRENT_USESHOTS';
$modversion['config'][6]['description'] = '_X_TORRENT_USESHOTSDSC';
$modversion['config'][6]['formtype'] = 'yesno';
$modversion['config'][6]['valuetype'] = 'int';
$modversion['config'][6]['default'] = 0;

$modversion['config'][21]['name'] = 'usethumbs';
$modversion['config'][21]['title'] = '_X_TORRENT_USETHUMBS';
$modversion['config'][21]['description'] = '_X_TORRENT_USETHUMBSDSC';
...
$modversion['config'][36]['title'] = '_X_TORRENT_IMGUPDATE';
$modversion['config'][36]['description'] = '_X_TORRENT_IMGUPDATEDSC';
...
$modversion['config'][37]['title'] = '_X_TORRENT_QUALITY';
$modversion['config'][37]['description'] = '_X_TORRENT_QUALITYDSC';
...
$modversion['config'][38]['title'] = '_X_TORRENT_KEEPASPECT';
$modversion['config'][38]['description'] = '_X_TORRENT_KEEPASPECTDSC';
...
$modversion['config'][7]['title'] = '_X_TORRENT_SHOTWIDTH';
$modversion['config'][7]['description'] = '_X_TORRENT_SHOTWIDTHDSC';
$modversion['config'][7]['formtype'] = 'textbox';
$modversion['config'][7]['valuetype'] = 'int';
$modversion['config'][7]['default'] = 140;

$modversion['config'][20]['name'] = 'shotheight';
$modversion['config'][20]['title'] = '_X_TORRENT_SHOTHEIGHT';
$modversion['config'][20]['description'] = '_X_TORRENT_SHOTHEIGHTDSC';
...
$modversion['config'][8]['title'] = '_X_TORRENT_CHECKHOST';
...
$modversion['config'][9]['title'] = '_X_TORRENT_REFERERS';
$modversion['config'][9]['description'] = '_X_TORRENT_REFERERSDSC';
...
$modversion['config'][15]['title'] = '_X_TORRENT_ALLOWSUBMISS';
$modversion['config'][15]['description'] = '_X_TORRENT_ALLOWSUBMISSDSC';
...
$modversion['config'][34]['title'] = '_X_TORRENT_SUBMITART';
$modversion['config'][34]['description'] = '_X_TORRENT_SUBMITARTDSC';
...
$modversion['config'][4]['title'] = '_X_TORRENT_ANONPOST';
$modversion['config'][4]['description'] = '_X_TORRENT_ANONPOSTDSC';
$modversion['config'][4]['formtype'] = 'yesno';
$modversion['config'][4]['valuetype'] = 'int';
$modversion['config'][4]['default'] = 0;

$modversion['config'][5]['name'] = 'autoapprove';
$modversion['config'][5]['title'] = '_X_TORRENT_AUTOAPPROVE';
$modversion['config'][5]['description'] = '_X_TORRENT_AUTOAPPROVEDSC';
$modversion['config'][5]['formtype'] = 'yesno';
$modversion['config'][5]['valuetype'] = 'int';
$modversion['config'][5]['default'] = 0;

$modversion['config'][16]['name'] = 'useruploads';
$modversion['config'][16]['title'] = '_X_TORRENT_ALLOWUPLOADS';
$modversion['config'][16]['description'] = '_X_TORRENT_ALLOWUPLOADSDSC';
...
$modversion['config'][10]['title'] = '_X_TORRENT_MAXFILESIZE';
$modversion['config'][10]['description'] = '_X_TORRENT_MAXFILESIZEDSC';
$modversion['config'][10]['formtype'] = 'textbox';
$modversion['config'][10]['valuetype'] = 'int';
$modversion['config'][10]['default'] = 200000;

$modversion['config'][11]['name'] = 'maximgwidth';
$modversion['config'][11]['title'] = '_X_TORRENT_IMGWIDTH';
$modversion['config'][11]['description'] = '_X_TORRENT_IMGWIDTHDSC';
$modversion['config'][11]['formtype'] = 'textbox';
$modversion['config'][11]['valuetype'] = 'int';
$modversion['config'][11]['default'] = 600;

$modversion['config'][12]['name'] = 'maximgheight';
$modversion['config'][12]['title'] = '_X_TORRENT_IMGHEIGHT';
$modversion['config'][12]['description'] = '_X_TORRENT_IMGHEIGHTDSC';
$modversion['config'][12]['formtype'] = 'textbox';
$modversion['config'][12]['valuetype'] = 'int';
$modversion['config'][12]['default'] = 600;

$modversion['config'][13]['name'] = 'uploaddir';
$modversion['config'][13]['title'] = '_X_TORRENT_UPLOADDIR';
$modversion['config'][13]['description'] = '_X_TORRENT_UPLOADDIRDSC';
...
$modversion['config'][19]['title'] = '_X_TORRENT_MAINIMGDIR';
$modversion['config'][19]['description'] = '_X_TORRENT_MAINIMGDIRDSC';
$modversion['config'][19]['formtype'] = 'textbox';
$modversion['config'][19]['valuetype'] = 'text';
$modversion['config'][19]['default'] = 'modules/xtorrent/images';

$modversion['config'][17]['name'] = 'screenshots';
$modversion['config'][17]['title'] = '_X_TORRENT_SCREENSHOTS';
$modversion['config'][17]['description'] = '_X_TORRENT_SCREENSHOTSDSC';
$modversion['config'][17]['formtype'] = 'textbox';
$modversion['config'][17]['valuetype'] = 'text';
$modversion['config'][17]['default'] = 'modules/xtorrent/images/screenshots';

$modversion['config'][18]['name'] = 'catimage';
$modversion['config'][18]['title'] = '_X_TORRENT_CATEGORYIMG';
$modversion['config'][18]['description'] = '_X_TORRENT_CATEGORYIMGDSC';
$modversion['config'][18]['formtype'] = 'textbox';
$modversion['config'][18]['valuetype'] = 'text';
$modversion['config'][18]['default'] = 'modules/xtorrent/images/category';

$modversion['config'][26]['name'] = 'platform';
$modversion['config'][26]['title'] = '_X_TORRENT_PLATFORM';
$modversion['config'][26]['description'] = '_X_TORRENT_PLATFORMDSC';
...
$modversion['config'][27]['title'] = '_X_TORRENT_LICENSE';
$modversion['config'][27]['description'] = '_X_TORRENT_LICENSEDSC';
...
$modversion['config'][33]['title'] = '_X_TORRENT_VERSIONTYPES';
$modversion['config'][33]['description'] = '_X_TORRENT_PLATFORMDSC';
...
$modversion['config'][31]['title'] = '_X_TORRENT_LIMITS';
$modversion['config'][31]['description'] = '_X_TORRENT_LIMITSDSC';
...
$modversion['config'][23]['title'] = '_X_TORRENT_DATEFORMAT';
$modversion['config'][23]['description'] = '_X_TORRENT_DATEFORMATDSC';
...
$modversion['config'][24]['title'] = '_X_TORRENT_SHOWDISCLAIMER';
$modversion['config'][24]['description'] = '_X_TORRENT_SHOWDISCLAIMERDSC';
...
$modversion['config'][25]['title'] = '_X_TORRENT_DISCLAIMER';
$modversion['config'][25]['description'] = '_X_TORRENT_DISCLAIMERDSC';
...
$modversion['config'][29]['title'] = '_X_TORRENT_SHOWDOWNDISCL';
$modversion['config'][29]['description'] = '_X_TORRENT_SHOWDOWNDISCLDSC';
...
$modversion['config'][30]['title'] = '_X_TORRENT_DOWNDISCLAIMER';
$modversion['config'][30]['description'] = '_X_TORRENT_DOWNDISCLAIMERDSC';
...
$modversion['config'][40]['title'] = '_X_TORRENT_COPYRIGHT';
$modversion['config'][40]['description'] = '_X_TORRENT_COPYRIGHTDSC';
...
$modversion['config'][43]['title'] = '_X_TORRENT_POLL_TORRENT';
$modversion['config'][43]['description'] = '_X_TORRENT_POLL_TORRENTDSC';
...
$modversion['config'][44]['title'] = '_X_TORRENT_POLL_TORRENTTIME';
$modversion['config'][44]['description'] = '_X_TORRENT_POLL_TORRENTTIMEDSC';
...
$modversion['config'][45]['title'] = '_X_TORRENT_POLL_TRACKER';
$modversion['config'][45]['description'] = '_X_TORRENT_POLL_TRACKERDSC';
...
$modversion['config'][46]['title'] = '_X_TORRENT_POLL_TRACKERTIME';
$modversion['config'][46]['description'] = '_X_TORRENT_POLL_TRACKERTIMEDSC';
...
$modversion['config'][47]['title'] = '_X_TORRENT_POLL_TRACKERTIMEOUT';
$modversion['config'][47]['description'] = '_X_TORRENT_POLL_TRACKERTIMEOUTDSC';
...
$modversion['config'][48]['title'] = '_X_TORRENT_OPEN';
$modversion['config'][48]['description'] = '_X_TORRENT_OPENDSC';
...
$modversion['config'][49]['title'] = '_X_TORRENT_THROTTLE';
$modversion['config'][49]['description'] = '_X_TORRENT_THROTTLEDSC';
...
$modversion['config'][50]['title'] = '_X_TORRENT_ANNOUNCEINTERVAL';
$modversion['config'][50]['description'] = '_X_TORRENT_ANNOUNCEINTERVALDSC';
$modversion['config'][50]['formtype'] = 'select';
$modversion['config'][50]['valuetype'] = 'int';
$modversion['config'][50]['default'] = 10;
$modversion['config'][50]['options'] = ['5' => 5, '10' => 10, '15' => 15, '20' => 20, '25' => 25, '30' => 30, '50' => 50];

$modversion['config'][51]['name'] = 'numleechers';
$modversion['config'][51]['title'] = '_X_TORRENT_NUMLEECHERS';
$modversion['config'][51]['description'] = '_X_TORRENT_NUMLEECHERSDSC';
$modversion['config'][51]['formtype'] = 'select';
$modversion['config'][51]['valuetype'] = 'int';
$modversion['config'][51]['default'] = 100;
$modversion['config'][51]['options'] = ['5' => 5, '10' => 10, '15' => 15, '20' => 20, '25' => 25, '50' => 50, '100' => 100, '125' => 125, '150' => 150, '200' => 200, '300' => 300, '400' => 400, '500' => 500, '750' => 750, '100' => 1000, '2000' => 2000, '3000' => 3000, 'Unlimited' => 0];

$modversion['config'][52]['name'] = 'numseeds';
$modversion['config'][52]['title'] = '_X_TORRENT_NUMSEEDS';
$modversion['config'][52]['description'] = '_X_TORRENT_NUMSEEDSDSC';
$modversion['config'][52]['formtype'] = 'select';
$modversion['config'][52]['valuetype'] = 'int';
$modversion['config'][52]['default'] = 25;
$modversion['config'][52]['options'] = ['5' => 5, '10' => 10, '15' => 15, '20' => 20, '25' => 25, '30' => 30, '50' => 50, '100' => 100, '125' => 125, '150' => 150, '200' => 200, '300' => 300, '400' => 400, '500' => 500, 'Unlimited' => 0];

$modversion['config'][53]['name'] = 'announce_url';
$modversion['config'][53]['title'] = '_X_TORRENT_ANNOUNCEURL';
$modversion['config'][53]['description'] = '_X_TORRENT_ANNOUNCEURLDSC';
...
$modversion['notification']['category'][1]['title'] = _X_TORRENT_GLOBAL_NOTIFY;
$modversion['notification']['category'][1]['description'] = _X_TORRENT_GLOBAL_NOTIFYDSC;
...
$modversion['notification']['category'][2]['title'] = _X_TORRENT_CATEGORY_NOTIFY;
$modversion['notification']['category'][2]['description'] = _X_TORRENT_CATEGORY_NOTIFYDSC;
...
$modversion['notification']['category'][3]['title'] = _X_TORRENT_FILE_NOTIFY;
$modversion['notification']['category'][3]['description'] = _X_TORRENT_FILE_NOTIFYDSC;
...
$modversion['notification']['event'][1]['title'] = _X_TORRENT_GLOBAL_NEWCATEGORY_NOTIFY;
$modversion['notification']['event'][1]['caption'] = _X_TORRENT_GLOBAL_NEWCATEGORY_NOTIFYCAP;
$modversion['notification']['event'][1]['description'] = _X_TORRENT_GLOBAL_NEWCATEGORY_NOTIFYDSC;
$modversion['notification']['event'][1]['mail_template'] = 'global_newcategory_notify';
$modversion['notification']['event'][1]['mail_subject'] = _X_TORRENT_GLOBAL_NEWCATEGORY_NOTIFYSBJ;

$modversion['notification']['event'][2]['name'] = 'file_modify';
$modversion['notification']['event'][2]['category'] = 'global';
$modversion['notification']['event'][2]['admin_only'] = 1;
$modversion['notification']['event'][2]['title'] = _X_TORRENT_GLOBAL_FILEMODIFY_NOTIFY;
$modversion['notification']['event'][2]['caption'] = _X_TORRENT_GLOBAL_FILEMODIFY_NOTIFYCAP;
$modversion['notification']['event'][2]['description'] = _X_TORRENT_GLOBAL_FILEMODIFY_NOTIFYDSC;
$modversion['notification']['event'][2]['mail_template'] = 'global_filemodify_notify';
$modversion['notification']['event'][2]['mail_subject'] = _X_TORRENT_GLOBAL_FILEMODIFY_NOTIFYSBJ;

$modversion['notification']['event'][3]['name'] = 'file_broken';
$modversion['notification']['event'][3]['category'] = 'global';
$modversion['notification']['event'][3]['admin_only'] = 1;
$modversion['notification']['event'][3]['title'] = _X_TORRENT_GLOBAL_FILEBROKEN_NOTIFY;
$modversion['notification']['event'][3]['caption'] = _X_TORRENT_GLOBAL_FILEBROKEN_NOTIFYCAP;
$modversion['notification']['event'][3]['description'] = _X_TORRENT_GLOBAL_FILEBROKEN_NOTIFYDSC;
$modversion['notification']['event'][3]['mail_template'] = 'global_filebroken_notify';
$modversion['notification']['event'][3]['mail_subject'] = _X_TORRENT_GLOBAL_FILEBROKEN_NOTIFYSBJ;
...
$modversion['notification']['event'][4]['title'] = _X_TORRENT_GLOBAL_FILESUBMIT_NOTIFY;
$modversion['notification']['event'][4]['caption'] = _X_TORRENT_GLOBAL_FILESUBMIT_NOTIFYCAP;
$modversion['notification']['event'][4]['description'] = _X_TORRENT_GLOBAL_FILESUBMIT_NOTIFYDSC;
$modversion['notification']['event'][4]['mail_template'] = 'global_filesubmit_notify';
$modversion['notification']['event'][4]['mail_subject'] = _X_TORRENT_GLOBAL_FILESUBMIT_NOTIFYSBJ;

$modversion['notification']['event'][5]['name'] = 'new_file';
$modversion['notification']['event'][5]['category'] = 'global';
$modversion['notification']['event'][5]['title'] = _X_TORRENT_GLOBAL_NEWFILE_NOTIFY;
$modversion['notification']['event'][5]['caption'] = _X_TORRENT_GLOBAL_NEWFILE_NOTIFYCAP;
$modversion['notification']['event'][5]['description'] = _X_TORRENT_GLOBAL_NEWFILE_NOTIFYDSC;
$modversion['notification']['event'][5]['mail_template'] = 'global_newfile_notify';
$modversion['notification']['event'][5]['mail_subject'] = _X_TORRENT_GLOBAL_NEWFILE_NOTIFYSBJ;
...
$modversion['notification']['event'][6]['title'] = _X_TORRENT_CATEGORY_FILESUBMIT_NOTIFY;
$modversion['notification']['event'][6]['caption'] = _X_TORRENT_CATEGORY_FILESUBMIT_NOTIFYCAP;
$modversion['notification']['event'][6]['description'] = _X_TORRENT_CATEGORY_FILESUBMIT_NOTIFYDSC;
$modversion['notification']['event'][6]['mail_template'] = 'category_filesubmit_notify';
$modversion['notification']['event'][6]['mail_subject'] = _X_TORRENT_CATEGORY_FILESUBMIT_NOTIFYSBJ;

$modversion['notification']['event'][7]['name'] = 'new_file';
$modversion['notification']['event'][7]['category'] = 'category';
$modversion['notification']['event'][7]['title'] = _X_TORRENT_CATEGORY_NEWFILE_NOTIFY;
$modversion['notification']['event'][7]['caption'] = _X_TORRENT_CATEGORY_NEWFILE_NOTIFYCAP;
$modversion['notification']['event'][7]['description'] = _X_TORRENT_CATEGORY_NEWFILE_NOTIFYDSC;
$modversion['notification']['event'][7]['mail_template'] = 'category_newfile_notify';
$modversion['notification']['event'][7]['mail_subject'] = _X_TORRENT_CATEGORY_NEWFILE_NOTIFYSBJ;
...
$modversion['notification']['event'][8]['title'] = _X_TORRENT_FILE_APPROVE_NOTIFY;
$modversion['notification']['event'][8]['caption'] = _X_TORRENT_FILE_APPROVE_NOTIFYCAP;
$modversion['notification']['event'][8]['description'] = _X_TORRENT_FILE_APPROVE_NOTIFYDSC;
$modversion['notification']['event'][8]['mail_template'] = 'file_approve_notify';
$modversion['notification']['event'][8]['mail_subject'] = _X_TORRENT_FILE_APPROVE_NOTIFYSBJ;
