...
switch ($op) {
    ...
    case 'edit':
        xoops_cp_header();
        xtorrent_adminmenu(_AM_XTORRENT_MMIMETYPES);
    ...
    default:
        ...
        echo "
		<fieldset><legend style='font-weight: bold; color: #900;'>" . _AM_XTORRENT_MIME_MODIFYF . "</legend>\n
		<div style='padding: 8px;'>" . _AM_XTORRENT_MIME_INFOTEXT . "</div>\n
		</fieldset>\n
		";
        ...
        echo "
		<fieldset><legend style='font-weight: bold; color: #900;'>" . _AM_XTORRENT_MIME_ADMINF . "</legend>\n
        ...
        echo '</tr>';
        while (false !== ($mimetypes = $xoopsDB->fetchArray($mime_array))) {
            echo '<tr>';
